...
export default class TransitInterface {
  ...
  * @returns {Promise<TransitDepartures>} A list of transit departures from the station
  */
   ...
   * @returns {Promise<TransitStoppingPattern>} The stopping pattern of the trip, or null if the run reference is invalid
   */
