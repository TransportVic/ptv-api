...
import MetroSiteInterface from './metroSite/metro-site-interface.mjs'
...
export default class PTVAPI {
  ...
  addMetroSite(metroSiteInterface) {
    this.metroSite = new MetroSiteInterface(metroSiteInterface)
  }
