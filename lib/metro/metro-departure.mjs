...
export default class MetroDeparture extends TransitDeparture {
  ...
  constructor(apiInterface, routeData, runData, scheduledDepartureTime, estimatedDepartureTime, departureStop, platform) {
    super(routeData, runData, scheduledDepartureTime, estimatedDepartureTime, departureStop)
  ...
  correctStationName() {
    if (this.departureStop === 'Jolimont-MCG') this.departureStop = 'Jolimont'
  }

  correctPlatform() {
    if (this.departureStop === 'Flemington Racecourse' && this.platform === '4') this.platform = '2'
  }
