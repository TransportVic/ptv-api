...
export default class MetroRun extends TransitRun {
   ...
   */
  constructor(runRef, destination, direction, position, description, tdn, isRailBus, viaCityLoop, interchange) {
  ...
  static fromPTVData(data, flags, line, direction) {
    ...
    return new MetroRun(data.run_ref, data.destination_name, direction, data.vehicle_position, data.vehicle_descriptor, tdn, isRailBus, viaCityLoop, data.interchange)
  }
