...
export class GetJourneyStopsAPI extends VLineJPMethod {
  ...
  getMethodURLPath() {
    ...
    .replace('{2}', dateLikeToISO(this.#departureTime))
...
export class VLineStoppingPattern extends Array {
  ...
  push(stop) {
    // TODO: Handle stop duplication during works vide 2024/350063
    super.push(stop)
  }
...
export class VLineTripStop {
  ...
  static fromVLineData($, stop) {
    ...
    return new VLineTripStop(location, parseISOTime(arrivalTime), parseISOTime(departureTime))
  }
