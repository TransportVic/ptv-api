...
export class VLinePlatformService {
  ...
  constructor(origin, destination, departureTime, arrivalTime, tdn, platform, direction, consistSize, apiInterface) {
    this.origin = origin
  ...
  static fromVLineData($, service, apiInterface) {
    ...
    let platformService = new VLinePlatformService(
      ...
      tdn, platform, this.getDirection(direction), consistSize,
      apiInterface
    )
