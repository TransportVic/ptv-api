  ...
  groupByTripID(data) {
    ...
    for (let trip of data) {
      ...
      if (trip.time_until_arrival !== null) {
        estimatedArrivalTime = parseMSTime((trip.modified + trip.time_until_arrival * 60) * 1000)
      }

      if (trip.time_until_departure !== null) {
        estimatedDepartureTime = parseMSTime((trip.modified + trip.time_until_departure * 60) * 1000)
      }
